...
import os
import warnings
from phoenix.otel import register  # Add this import
...
class LazyLiteLLM:
    _lazy_module = None
    _phoenix_initialized = False  # Track Phoenix initialization
    ...
    def _load_litellm(self):
        ...
        # Initialize Phoenix first if enabled
